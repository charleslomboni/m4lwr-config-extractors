...
Date        : 29/11/2022
Goal        : Search for SETTINGS resource used in a remcos
            : variant and decrypt the RC4 configs
Dependences : pip install arc4
            : pip install pefile
M4lwr       : https://malpedia.caad.fkie.fraunhofer.de/details/win.remcos
"""
